...
const Config = {
  ...
  TIME: {
    ...
    ARRIVE_NOTIFICATION_1: 10,
    ARRIVE_NOTIFICATION_2: 5,
    ARRIVE_NOTIFICATION_3: 1,
    LATE_THRESHOLD: 10,
    ABSENT_THRESHOLD: 30,
    BUFFER_TIME: 10  // 출발과 도착 사이의 여유 시간
  },
  ...
  NOTIFICATION_TYPE: {
    ...
    ARRIVE_10MIN: 'ARRIVE_10MIN',
    ARRIVE_5MIN: 'ARRIVE_5MIN',
    ARRIVE_1MIN: 'ARRIVE_1MIN',
